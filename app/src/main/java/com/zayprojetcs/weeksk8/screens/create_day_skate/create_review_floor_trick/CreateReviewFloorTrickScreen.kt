package com.zayprojetcs.weeksk8.screens.create_day_skate.create_review_floor_trick
...
@Composable
fun CreateReviewFloorTrickScreen(
    ...
    LabelSectionContentCustom(
        ...
        LazyColumn(
            ...
            items(createDaySkateUiStateModel.unlockTrickList) { trick ->
                ItemTrickCustom(trick = trick)
            }
            items(createDaySkateUiStateModel.unlockNewTrickList) { trick ->

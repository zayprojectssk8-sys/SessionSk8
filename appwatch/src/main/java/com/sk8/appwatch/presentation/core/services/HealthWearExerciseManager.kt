...
import com.sk8.appwatch.presentation.utils.TrimpCalculatorUtils
...
class HealthWearExerciseManager(val context: Context) {
    ...
    fun startSkateSession(): Flow<MetricsSessionModel> = callbackFlow {
        ...
        impactDetectorSensor = ImpactDetectorSensor(context) { gForce ->
            fallCount++
    ...
    suspend fun stopSkateSession() {
        ...
        val finalTrimp = TrimpCalculatorUtils.calculate(
